...
class TemplateNameParserTest extends TestCase
{
    ...
    public function parseProvider()
    {
        return array(
            ...
            array('FooBundle:Post:produits.html.twig', 'FooBundle:Post:produits.html.twig', '@FooBundle/Resources/views/Post/produits.html.twig', new TemplateReference('FooBundle', 'Post', 'index', 'html', 'twig')),
